 ...
 * @LastEditTime: 2020-08-12 11:44:20
 * @LastEditors: justin
...
async function start(){
    ...
    await copyTheme();
    //less编译nebula.ui样式
    // let antdLessResult = await complieLess('@import "node_modules/nebula-ui/lib/style/antd.less";',path.join(process.cwd(), './static/css/antd.css'));
